#!/usr/bin/env python3
# This tool stays in Python so the Pages site build does not need to build
# the compiler. Do not port it to an x2c script.
...
def generated(path: pathlib.Path) -> bool:
    with path.open(encoding="utf-8", errors="replace") as handle:
        return handle.readline().startswith("// Generated by ")
