...
| C09 | Docs consume compiler-selected definitions | Moved 2026-09-24 into the compiler-backed tool rewrite, now in [x2c-lint-and-format](x2c-lint-and-format.md) | Docs no longer re-expand source macros or independently recognize declaration families |
