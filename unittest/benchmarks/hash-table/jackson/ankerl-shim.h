// ankerl::unordered_dense shim for x2c's 32-bit production Var hash.

#include "../ankerl_unordered_dense/unordered_dense.h"

template< typename blueprint > struct x2c_ankerl_unordered_dense
{
  struct hash
  {
    std::size_t operator()(
...
template<> struct x2c_ankerl_unordered_dense< void >
{
