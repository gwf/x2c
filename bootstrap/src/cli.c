...
static String _69, _68, _67, _66, _65, _64, _63, _62, _61, _60, _59, _58, _57, _56, _55, _54, _53, _52, _51, _50, _49, _48, _47, _46, _45, _44, _43, _42, _41, _40, _39, _38, _37, _36, _35, _34, _33, _32, _31, _30, _29, _28, _27, _26, _25, _24, _23, _22, _21, _20, _19, _18, _17, _16, _15, _14, _13, _12, _11, _10, _9, _8, _7, _6, _5, _4, _3, _2, _1, _0;
...
static CliOption cli_options[] ={
  {
    535328, CLI_TOP | CLI_TRANSLATE | CLI_NATIVE | CLI_BOOTSTRAP | CLI_ENV | CLI_INSTALL | CLI_REMOVE | CLI_LIST | CLI_NEW, 15397654616, "-h, --help", NULL, "Show help and exit", 0
  }
  , {
  ...
  , {
    37046632, CLI_TRANSLATE | CLI_BUILD | CLI_RUN | CLI_BOOTSTRAP | CLI_INSTALL | CLI_REMOVE | CLI_NEW, 15397654616, "-q, --quiet", NULL, "Suppress successful progress and receipts", 0
  }
  , {
  ...
  , {
    9417250982666, CLI_TRANSLATE | CLI_NATIVE, 15397654616, "--diagnostics-file", "<file>", "Write compiler diagnostics to <file> as JSON Lines", 0
  }
  , {
    33665524324, CLI_TRANSLATE, 1052018024, "--out-dir", "<dir>", "Write generated files under <dir> (default: .)", 0
  }
  , {
    42018498656, CLI_TRANSLATE | CLI_NATIVE, 1052018024, "--source-map", NULL, "Map generated C locations to original x2c sources", 0
  }
  , {
  ...
  , {
    686246, CLI_TRANSLATE | CLI_NATIVE, 1345468776, "-j, --jobs", "<count>", "Maximum parallel translation and compilation jobs", 0
  }
  , {
  ...
  , {
    20273998090, CLI_TRANSLATE | CLI_NATIVE, 1307939018, "-I", "<dir>", "Add a shared x2c/C include directory", 0
  }
  , {
    54927135910154, CLI_TRANSLATE | CLI_NATIVE, 1307939018, "--x-include-dir", "<dir>", "Add an x2c-only include directory", 0
  }
  , {
    8747647543562, CLI_NATIVE, 1307939018, "--c-include-dir", "<dir>", "Add a C-only ordinary include directory", 0
  }
  , {
    274059207002, CLI_NATIVE, 1307939018, "--c-system-dir", "<dir>", "Add a C-only system include directory", 0
  }
  , {
    35114656356, CLI_TRANSLATE | CLI_NATIVE | CLI_ENV, 1307939018, "--package-dir", "<dir>", "Add a directory of x2c packages", 0
  }
  , {
  ...
  , {
    198, CLI_NATIVE | CLI_BOOTSTRAP | CLI_ENV, 279515230724452, "--cc", "<program>", "Use <program> as the host C compiler", 0
  }
  , {
    100, CLI_BUILD | CLI_BOOTSTRAP | CLI_ENV, 279515230724452, "--ar", "<program>", "Use <program> as the static-library archiver", 0
  }
  , {
    31784, CLI_NATIVE | CLI_BOOTSTRAP, 279515230724452, "-O0, -O1, -O2, -O3, -Os", NULL, "Set C optimization", 0
  }
  , {
    14, CLI_NATIVE, 279515230724452, "-g", NULL, "Emit debug information", 0
  }
  , {
    279333770, CLI_NATIVE, 279515230724452, "-D", "<name>[=<value>]", "Define a C preprocessor macro", 0
  }
  , {
    1473453116298, CLI_NATIVE, 279515230724452, "-U", "<name>", "Undefine a C preprocessor macro", 0
  }
  , {
    49350, CLI_NATIVE, 279515230724452, "-Xcc", "<arg>", "Pass one argument only to C compilation", 0
  }
  , {
    26380018276, CLI_NATIVE, 825121124, "-L", "<dir>", "Add a library search directory", 0
  }
  , {
    26379160754, CLI_NATIVE, 825121124, "-l", "<name>", "Link library <name>", 0
  }
  , {
    38800656, CLI_NATIVE, 825121124, "--rpath", "<dir>", "Search <dir> for shared libraries when the program runs", 0
  }
  , {
    1496, CLI_NATIVE, 825121124, "-Wl,<arg>[,<arg>...]", NULL, "Pass comma-separated arguments to the linker", 0
  }
  , {
    35719882824, CLI_NATIVE, 279515230724452, "-pthread", NULL, "Enable native threading for compilation and linking", 0
  }
  , {
    14434122038422, CLI_NATIVE, 825121124, "-framework", "<name>", "Link a native framework on macOS", 0
  }
  , {
    52364728676, CLI_NATIVE, 825121124, "-Xlinker", "<arg>", "Pass one argument to the linker", 0
  }
  , {
...
__attribute__((constructor)) static void _file_init_(void){
  ...
  _18 = String_new("The target is named after the last component of <dir>, which may\ncontain letters, digits, \'_\', and \'-\'. Run \'x2c run\' in <dir> next.");
  ...
  _28 = String_new("shared-library");
  _29 = String_new("unknown target kind \'");
  _30 = String_new("invalid ");
  _31 = String_new(" \'");
  _32 = String_new("auto");
  _33 = String_new("always");
  _34 = String_new("never");
  _35 = String_new("invalid color mode \'");
  _36 = String_new("C dependency option is driver-owned \'");
  _37 = String_new("-Wl,-rpath,");
  _38 = String_new("unsupported package native argument \'");
  _39 = String_new("-");
  _40 = String_new("--");
  _41 = String_new("unexpected bootstrap operand \'");
  _42 = String_new("-o");
  _43 = String_new("unknown option \'");
  _44 = String_new(" requires exactly one operand");
  _45 = String_new("--help");
  _46 = String_new("-h");
  _47 = String_new("--version");
  _48 = String_new("-V");
  _49 = String_new("help");
  ...
  _59 = String_new(",-MT");
  _60 = String_new("-I");
  _61 = String_new("job count");
  _62 = String_new("error limit");
  _63 = String_new("-isystem");
  _64 = String_new("{package}");
  _65 = String_new(".a");
  _66 = String_new("@");
  _67 = String_new("--save-temps=");
  _68 = String_new("-O2");
  _69 = String_new("x2c 0.14.0");
}
...
static void _print_package_help(Symbol command){
  if(command == 20308036376) puts(_13);
  else if(command == 1219329418) puts(_14);
  else puts(_15);
  _print_options(command);
  _print_help_row("@<file>", "Read additional arguments from a response file", 2);
...
static void _print_help(Symbol command){
  switch(command){
    ...
    break;
    case 535328 : puts(_21);
    break;
    default: x2c_driver_error(String_join(NULL, cons(String_var(_22), cons(String_var(Symbol_str(command)), cons(String_var(_23), NULL)))));
  }
...
int cli_dependency_pass_through(String s){
  ...
  return String_truth(s) &&(String_startswith(s, _52) || String_startswith(s, _53) || String_startswith(s, _54) || String_startswith(s, _55) || String_contains(s, _56) || String_contains(s, _57) || String_contains(s, _58) || String_contains(s, _59));
}

static void _driver_kind(CliRequest request, String value){
  request -> kind_explicit = 1;
  if(String_equal(value, _26)) request -> kind = 404971770155786;
  else if(String_equal(value, _27)) request -> kind = 1381098885964356;
  else if(String_equal(value, _28)) x2c_driver_error("shared-library is not supported by this compiler");
  else x2c_driver_error(String_join(NULL, cons(String_var(_29), cons(String_var(value), cons(String_var(_23), NULL)))));
}
...
static int _driver_count(String value, int minimum, String noun){
  ...
  if(! String_truth(value) || errno || * end || count < minimum || count > INT_MAX) x2c_driver_error(String_join(NULL, cons(String_var(_30), cons(String_var(noun), cons(String_var(_31), cons(String_var(value), cons(String_var(_23), NULL)))))));
  return(int) count;
}
...
static void _apply_option(CliRequest c, CliOption * option, String spelling, String value, int attached, Array x_paths, Array cpp_args, Array cc_args, Array ld_args){
  switch(option -> id){
    ...
    if(String_equal(value, _32)) c -> color_mode = 109854;
    else if(String_equal(value, _33)) c -> color_mode = 93785702;
    else if(String_equal(value, _34)) c -> color_mode = 29733220;
    else x2c_driver_error(String_join(NULL, cons(String_var(_35), cons(String_var(value), cons(String_var(_23), NULL)))));
    break;
    ...
    if(c -> command != 45220543335690) _push_pair(cc_args, _60, value);
    break;
    ...
    break;
    case 686246 : c -> jobs = _driver_count(value, 1, _61);
    break;
    case 918708911504550 : c -> max_errors = _driver_count(value, 0, _62);
    break;
    ...
    break;
    case 8747647543562 : _push_pair(cc_args, _60, value);
    break;
    case 274059207002 : _push_pair(cc_args, _63, value);
    break;
    case 198 : c -> cc = value;
    break;
    case 100 : c -> ar = value;
    ...
    break;
    case 49350 : if(cli_dependency_pass_through(value)) x2c_driver_error(String_join(NULL, cons(String_var(_36), cons(String_var(value), cons(String_var(_23), NULL)))));
    ...
    break;
    case 38800656 : Array_push(ld_args, String_var(String_join(NULL, cons(String_var(_37), cons(String_var(value), NULL)))));
    break;
  ...
  {
    {
      ...
      while(List_try_next(_x2c_macro_object_2, & _x2c_macro_cursor_2, & _x2c_macro_cursor_output_2)){
        ...
        Array_push(words, String_var(String_replace(word, _64, package)));
      }
    ...
    for(int i = 0;  i < Array_len(words);  i ++){
      ...
      if(String_getindex(argument, 0) != '-' && String_getindex(argument, 0) != '@' && String_endswith(argument, _65)){
      ...
      if(! option) x2c_driver_error(String_join(NULL, cons(String_var(_38), cons(String_var(argument), cons(String_var(_23), NULL)))));
      switch(option -> id){
        ...
        default: x2c_driver_error(String_join(NULL, cons(String_var(_38), cons(String_var(argument), cons(String_var(_23), NULL)))));
      }
...
static void _one_dash_removed(String arg){
  const char * attached;
  if(strlen(arg) > 2 && String_getindex(arg, 0) == '-' && String_getindex(arg, 1) != '-' && _find_option(String_join(NULL, cons(String_var(_39), cons(String_var(arg), NULL))), CLI_TRANSLATE, & attached)){
...
static CliRequest _parse_command(Array args, CliCommand * command){
  ...
  for(int i = 1;  i < Array_len(args);  i ++){
    ...
    if(mask != CLI_BOOTSTRAP && ! operands && dashed && String_equal(arg, _40)){
      operands = 1;
      continue;
    }
    if(mask == CLI_BOOTSTRAP && ! dashed) x2c_driver_error(String_join(NULL, cons(String_var(_41), cons(String_var(arg), cons(String_var(_23), NULL)))));
    if(mask == CLI_SCRIPT && ! operands && i >= expanded_end && String_startswith(arg, _66)){
    ...
    if(mask != CLI_BOOTSTRAP && String_equal(arg, _42)) _removed_output();
    if((mask &(CLI_BUILD | CLI_RUN)) && String_startswith(arg, _67)){
      request -> save_temps = 1;
      request -> temps_dir = String_remove_prefix(arg, _67);
    ...
    if(! option){
      ...
      x2c_driver_error(String_join(NULL, cons(String_var(_43), cons(String_var(arg), cons(String_var(_23), NULL)))));
    }
  ...
  if(mask == CLI_BOOTSTRAP && ! Array_len(cc_args)) Array_push(cc_args, String_var(_68));
  ...
  if((mask == CLI_INSTALL || mask == CLI_REMOVE || mask == CLI_NEW) &&(! List_truth(request -> inputs) || List_truth(List_cdr(request -> inputs)))) x2c_driver_error(String_join(NULL, cons(String_var(Symbol_str(name)), cons(String_var(_44), NULL))));
...
CliRequest cli_parse(int argc, char * * argv){
  ...
  x2c_cleanup_push(&_x2c_defer_record_1);
  {
    ...
    if(String_equal(first, _45) || String_equal(first, _46)){
      _print_help(0);
      exit(0);
    }
    ...
    if(String_equal(first, _49)){
      ...
      if(String_equal(name, _49) || String_equal(name, _45) || String_equal(name, _46)) _print_help(535328);
      else if(asked) _print_help(asked -> name);
      else x2c_driver_error(String_join(NULL, cons(String_var(_22), cons(String_var(name), cons(String_var(_23), NULL)))));
      exit(0);
    }
    ...
    if(String_equal(first, _42)) _removed_output();
    const char * attached;
    if(strlen(first) > 2 && String_getindex(first, 0) == '-' && String_getindex(first, 1) != '-' && _find_option(String_join(NULL, cons(String_var(_39), cons(String_var(first), NULL))), CLI_TRANSLATE, & attached)){
      fprintf(stderr, "x2c: error: one-dash long option '%s' was removed\n", first);
      fprintf(stderr, "note: use 'x2c translate --%s ...'\n", first + 1);
      exit(2);
    }
    if(String_getindex(first, 0) != '-') _expected_command(first);
    x2c_driver_error(String_join(NULL, cons(String_var(_50), cons(String_var(first), cons(String_var(_23), NULL)))));
  }
  x2c_cleanup_leave(& _x2c_defer_record_1);
