...
static List _195, _193, _192, _190, _188, _185, _183, _182, _180, _178, _124, _123, _122, _121, _120, _108, _107, _106, _105, _34, _33, _32;
...
static Var _194, _191, _189, _187, _184, _181, _179, _177, _175, _119, _117, _115, _113, _111, _104, _102, _100, _98, _76, _74, _31, _29, _27, _12;
...
_x2c_initializer_choice_8309C62D_1((_x2c_func_handle_0 = Func_new(_x2c_func_adapt_0, _185)))
...
CliRequest Build_module_entry(Build b){
  ...
  Array directories = Array_new(), sources = Array_new();
  {
    String unit;
    ...
    while(Array_try_next(_x2c_macro_object_10, & _x2c_macro_cursor_10, & _x2c_macro_cursor_output_10)){
      ...
      {
        includes = String_join(NULL, cons(String_var(includes), cons(String_var(_42), cons(String_var(Path_basename(unit)), cons(String_var(_43), NULL)))));
        Array_push(directories, String_var(Path_dirname(unit)));
        Array_push(sources, String_var(Path_absolute(unit)));
      }
  ...
  ErrorHandler volatile _x2c_error_handler_4 = x2c_error_catch_site_push(&_x2c_exception_frame_4, &_x2c_catch_site_4, _x2c_catch_patterns_4);  x2c_exception_push(& _x2c_exception_frame_4);  if (!sigsetjmp(_x2c_exception_frame_4.env, 0)){
    Path_make_dirs(Path_dirname(entry));  Path_write_text(entry, String_join(NULL, cons(String_var(includes), cons(String_var(_45), cons(String_var(root), cons(String_var(_46), cons(String_var(declared), cons(String_var(_47), cons(String_var(build_compiler_stamp()), cons(String_var(_48), NULL))))))))));
  }
...
request -> include_dirs = List_append(b -> request -> include_dirs, List_append(Array_list_free(directories), NULL));
b -> xlat_n ++;
return request;
}
...
void Build_report_success(Build b){
  ...
  String label = String_truth(b -> request -> label) ? String_join(NULL, cons(String_var(_77), cons(String_var(b -> request -> label), cons(String_var(_78), NULL)))) : _163;
  String result;
  ...
  if(b -> cc_n){
    ...
    String jobs = count == 1 ? _169 : String_join(NULL, cons(String_var(int_str(count)), cons(String_var(_88), NULL)));
  ...
  }
  {
    ...
    while(List_try_next(_x2c_macro_object_24, & _x2c_macro_cursor_24, & _x2c_macro_cursor_output_24)){
      path = Var_string(_x2c_macro_cursor_output_24);
      {
        ...
        hash = _state_text(hash, Path_is_dir(path) ? String_printf(_109, Path_modified_time(path)) : _174);
      }
