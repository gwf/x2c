...
static String _86,  _81,  _80,  _79,  _78,  _77,  _76,  _75,  _74,  _73,  _72,  _71,  _70,  _69,  _68,  _67,  _66,  _65,  _64,  _63,  _62,  _61,  _60,  _59,  _58,  _57,  _56,  _55,  _54,  _53,  _52,  _51,  _50,  _49,  _48,  _47,  _46,  _45,  _44,  _43,  _42,  _41,  _40,  _39,  _38,  _37,  _36,  _35,  _34,  _33,  _32,  _31,  _30,  _29,  _28,  _27,  _26,  _25,  _24,  _23,  _22,  _21,  _20,  _19,  _18,  _17,  _16,  _15,  _14,  _13,  _12,  _11,  _10,  _9,  _8,  _7,  _6,  _5,  _4,  _3,  _2,  _1,  _0;
...
__attribute__((constructor)) static void _file_init_(void){
  ...
  _42 = String_new("/lib");
  _43 = String_new(".link");
  _44 = String_new("x2c file");
  _45 = String_new("x2c files");
  _46 = String_new("/c-");
  _47 = String_new("C file");
  _48 = String_new("C files");
  _49 = String_new("/run");
  _50 = String_new("/final-");
  _51 = String_new("object");
  _52 = String_new("objects");
  _53 = String_new("input");
  _54 = String_new("inputs");
  _55 = String_new(" (up to date)");
  ...
  _64 = String_new("executable");
  _65 = String_new("header");
  _66 = String_new("headers");
  _67 = String_new("  Generated ");
  _68 = String_new(" and ");
  _69 = String_new(" (");
  _70 = String_new(")");
  _71 = String_new("1 job");
  _72 = String_new(" jobs");
  _73 = String_new("  Compiled with ");
  _74 = String_new(" using ");
  _75 = String_new("  Archived with ");
  _76 = String_new("  Linked with ");
  _77 = String_new("temporary; removed after build");
  _78 = String_new("retained");
  _79 = String_new("  Intermediates ");
  _80 = String_new("  Output ");
  _81 = String_new("Running ");
  _86 = String_new("/");
}
...
static uint64_t _translation_fingerprint(Build state,  String input,  String directory,  int * ok){
  ...
  String depfile = String_join(NULL,  cons(String_var(directory),  cons(String_var(_2),  cons(String_var(x2c_path_stem(input)),  cons(String_var(_34),  NULL)))));
...
int Build_translation_current(Build state,  String input,  String directory){
  ...
  if(access(String_join(NULL,  cons(String_var(directory),  cons(String_var(_2),  cons(String_var(stem),  cons(String_var(_35),  NULL))))),  R_OK)) return 0;
  int ok = 1;
...
void Build_record_translation(Build state,  String input,  String directory){
  ...
  int ok = 1;
  uint64_t hash = _translation_fingerprint(state,  input,  directory,  & ok);
  if(ok) _state_write(String_join(NULL,  cons(String_var(state -> state_root),  cons(String_var(_36),  cons(String_var(_key(input)),  NULL)))),  hash);
}
  ...
  String canonical = String_join(NULL,  cons(String_var(String_new(buffer)),  NULL));
  {
    ...
    while(Iter_try_next(_x2c_macro_iterator_5,  & _x2c_macro_item_5)){
      candidate = Var_string(_x2c_macro_item_5);
      {
        ...
        int slash = String_find(String_getslice(canonical,  String_len(root),  -2147483648,  1),  _86);
...
static String _package_source_directory(List roots,  String path){
  ...
  if(String_startswith(canonical,  String_join(NULL,  cons(String_var(directory),  cons(String_var(_37),  NULL))))) return directory;
  ...
  String depfile = String_join(NULL,  cons(String_var(directory),  cons(String_var(_2),  cons(String_var(x2c_path_stem(input)),  cons(String_var(_34),  NULL)))));
  {
    ...
    while(Iter_try_next(_x2c_macro_iterator_7,  & _x2c_macro_item_7)){
      dependency = Var_string(_x2c_macro_item_7);
      {
        ...
        String name = Var_string(List_last(String_split(package,  _2))),  archive = String_join(NULL,  cons(String_var(builds),  cons(String_var(_42),  cons(String_var(name),  cons(String_var(_13),  NULL)))));
        ...
        _package_link_flags(state,  name,  String_join(NULL,  cons(String_var(builds),  cons(String_var(_2),  cons(String_var(name),  cons(String_var(_43),  NULL))))));
      }
...
void Build_add_generated(Build state,  String input,  String directory){
  ...
  String header = String_join(NULL,  cons(String_var(directory),  cons(String_var(_2),  cons(String_var(stem),  cons(String_var(_35),  NULL)))));
...
void Build_end_translation(Build state,  String input,  int cached){
  ...
  if(state -> xlat_done == state -> xlat_n){
    ...
    report_phase(45220543335690,  state -> xlat_n,  state -> xlat_n == 1 ? _44 : _45,  state -> xlat_cached,  elapsed);
  }
...
static int _compile_sources(Build b){
  ...
  {
    Var value;
    Iter _x2c_macro_iterator_10 = Array_iter(b -> c_sources,  &(struct Iter){
      0
    }
    );
    ...
    while(Iter_try_next(_x2c_macro_iterator_10,  & _x2c_macro_item_10)){
      value = _x2c_macro_item_10;
      {
        ...
        String depfile = String_join(NULL,  cons(String_var(b -> dep_root),  cons(String_var(_2),  cons(String_var(key),  cons(String_var(_34),  NULL)))));
        ...
        {
          Var directory;
          Iter _x2c_macro_iterator_9 = Array_iter(b -> gen_dirs,  &(struct Iter){
            0
          }
          );
          Var _x2c_macro_item_9;
          while(Iter_try_next(_x2c_macro_iterator_9,  & _x2c_macro_item_9)){
            directory = _x2c_macro_item_9;
        ...
        String state_path = String_truth(b -> state_root) ? String_join(NULL,  cons(String_var(b -> state_root),  cons(String_var(_46),  cons(String_var(_key(source)),  NULL)))) : NULL;
        ...
        if(running_count >= b -> request -> jobs){
          ...
          running_count --;
          if(running_count) memmove(running,  running + 1,  running_count * sizeof(CcJob));
          if(failed) break;
        }
...
static List _native_action_inputs(Build state){
  ...
  {
    Var value;
    Iter _x2c_macro_iterator_11 = Array_iter(state -> objects,  &(struct Iter){
      0
    }
    );
    Var _x2c_macro_item_11;
    while(Iter_try_next(_x2c_macro_iterator_11,  & _x2c_macro_item_11)){
      value = _x2c_macro_item_11;
  ...
  {
    Var value;
    Iter _x2c_macro_iterator_12 = Array_iter(state -> native_inputs,  &(struct Iter){
      0
    }
    );
...
void Build_report_success(Build b){
  ...
  String cache = _all_cached(b) ? _55 : 0;
  String label = String_truth(b -> request -> label) ? String_join(NULL,  cons(String_var(_56),  cons(String_var(b -> request -> label),  cons(String_var(_57),  NULL)))) : 0;
  String result;
  if(b -> request -> compile_only){
    ...
    String kind = b -> request -> kind == 1381098885964356 ? _63 : _64;
  ...
  if(b -> xlat_n){
    ...
    String h_noun = b -> xlat_n == 1 ? _65 : _66;
    report_line(28680520,  String_add(String_join(NULL,  cons(String_var(_67),  cons(String_var(int_str(b -> xlat_n)),  cons(String_var(_61),  cons(String_var(c_noun),  cons(String_var(_68),  NULL)))))),  String_join(NULL,  cons(String_var(int_str(b -> xlat_n)),  cons(String_var(_61),  cons(String_var(h_noun),  cons(String_var(_69),  cons(String_var(size),  cons(String_var(_70),  NULL)))))))));
  }
  if(b -> cc_n){
    int count = b -> request -> jobs;
    String jobs = count == 1 ? _71 : String_join(NULL,  cons(String_var(int_str(count)),  cons(String_var(_72),  NULL)));
    report_line(28680520,  String_join(NULL,  cons(String_var(_73),  cons(String_var(b -> toolchain -> cc),  cons(String_var(_74),  cons(String_var(jobs),  NULL))))));
  }
  if(! b -> request -> compile_only){
    if(b -> request -> kind == 1381098885964356) report_line(28680520,  String_join(NULL,  cons(String_var(_75),  cons(String_var(b -> toolchain -> ar),  NULL))));
    else report_line(28680520,  String_join(NULL,  cons(String_var(_76),  cons(String_var(b -> toolchain -> cc),  NULL))));
  }
  String retention = b -> temporary ? _77 : _78;
  report_line(28680520,  String_join(NULL,  cons(String_var(_79),  cons(String_var(b -> work_dir),  cons(String_var(_69),  cons(String_var(retention),  cons(String_var(_70),  NULL)))))));
  if(! b -> request -> compile_only){
    String size = report_size(report_file_bytes(b -> output));
    report_line(28680520,  String_join(NULL,  cons(String_var(_80),  cons(String_var(b -> output),  cons(String_var(_69),  cons(String_var(size),  cons(String_var(_70),  NULL)))))));
  }
...
int Build_run_program(Build state){
  if(! _init_guard_) _file_init_();
  report_line(34081994,  String_join(NULL,  cons(String_var(_81),  cons(String_var(state -> output),  NULL))));
  Array arguments = Array_new();
  Array_push(arguments,  String_var(state -> output));
  {
    String argument;
    Iter _x2c_macro_iterator_13 = List_iter(state -> request -> run_args,  &(struct Iter){
      0
    }
    );
    Var _x2c_macro_item_13;
    while(Iter_try_next(_x2c_macro_iterator_13,  & _x2c_macro_item_13)){
      argument = Var_string(_x2c_macro_item_13);
