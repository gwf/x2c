...
__attribute__((constructor)) static void _file_init_(void){
  ...
  _638 = cons(_635, _637);
  _639 = cons(_553, _46);
  _640 = Atom_intern(String_new("definition-span"));
  _641 = Symbol_var(64057516331336);
  _642 = cons(_641, _596);
  _643 = cons(_594, _642);
  _644 = List_var(_643);
  _645 = cons(_644, _344);
  ...
  _655 = cons(_203, _654);
  _656 = cons(_61, _655);
  _657 = String_new("typedef chain too deep (possible cycle) resolving ");
  _658 = Symbol_var(61557640);
  _659 = cons(_490, NULL);
  _660 = cons(_658, _659);
  _661 = cons(_594, _660);
  _662 = List_var(_661);
  ...
  _666 = cons(_665, NULL);
  _667 = cons(_662, _666);
  _668 = Symbol_var(1474468213064);
  _669 = Symbol_var(213092);
  _670 = cons(_669, NULL);
  _671 = cons(_668, _670);
  _672 = Symbol_var(1294430536);
  _673 = cons(_672, _670);
  _674 = Symbol_var(40402088);
  _675 = cons(_674, NULL);
  _676 = cons(_668, _675);
  _677 = cons(_668, NULL);
  _678 = Symbol_var(19368);
  _679 = cons(_678, NULL);
  _680 = Symbol_var(818062);
  _681 = cons(_680, NULL);
  _682 = cons(_668, _681);
  _683 = cons(_680, _681);
  _684 = cons(_668, _683);
  _685 = Symbol_var(13400168);
  _686 = cons(_685, NULL);
  _687 = Symbol_var(301273866);
  _688 = cons(_687, NULL);
  _689 = cons(_680, _688);
  _690 = String_new("field-order");
  _691 = String_var(_690);
  _692 = cons(_691, NULL);
  _693 = Symbol_var(421880102);
  ...
  _705 = String_new("inconsistent indentation");
  _706 = String_new("invalid token");
  _707 = String_new("unexpected '}'");
  _708 = String_new("missing '}'");
  _709 = String_new("unexpected end of file");
  _710 = String_new("<stdin>");
  _711 = String_new("a script that defines main cannot have top-level statements");
  _712 = String_new("<");
  _713 = String_new("a forwarded class constructor has no completed parent constructor");
  _714 = String_new("pragma private");
  _715 = String_new("pragma public");
  _716 = String_new("_x2c_");
  _717 = String_new("alias");
  _718 = String_new("name");
  _719 = String_new("local_typedef");
  _720 = String_new("var_converter_shadow");
  _721 = String_new("function");
  _722 = String_new("List");
  _723 = String_new("Func");
  _724 = String_new("variable");
  _725 = String_new("Var");
  _726 = String_new("String");
  _727 = String_new("Array");
  _728 = String_new("Map");
  _729 = String_new("");
}
...
Symbol preproc_never_active_arm(String s){
  ...
  for(Token t = _skip_forward(scanned -> tokens);  t -> type != 11212;  t = _skip_forward(t + 1)) Array_push(words, _never_defined(t -> text) ? String_var(_698) : String_var(t -> text));
  String line = String_replace(String_join(_15, Array_list_free(words)), _699, _700);
  if(String_equal(line, _16) || String_equal(line, _17) || String_equal(line, _18) || String_equal(line, _19) ||(String_startswith(line, _701) && ! String_contains(line, _702))) return 13210856;
...
static void _report_malformed_token(Compiler c){
  ...
  for(size_t i = 0;  i < Bytes_len(c -> tokenizer -> tokens);  i ++){
    Token token = &((struct Token *) c -> tokenizer -> tokens)[i];
    if(token -> type == 11703268) Compiler_report_error(c, 33658058, status == 633613224 ? _705 : _706, token, NULL);
  }
...
static void _update_brace_stack(Compiler c, Token consumed){
  ...
  switch(consumed -> type){
    ...
    case 251 : if(Array_len(c -> braces)) Array_take_last(c -> braces);
      ...
      List notes = _32;
      Compiler_report_error(c, 33658058, _707, consumed, notes);
    }
    break;
  }
...
static void _check_unmatched_braces(Compiler c){
  ...
  Compiler_report_error(c, 33658058, _708, Var_token(Array_getindex(c -> braces, - 1)), _35);
}
...
static void _shallow_block(Compiler c){
  ...
  while((peek = Compiler_peek(c, 0)) != 251){
    if(peek == 11212) Compiler_report_error(c, 33658058, _709, c -> token, NULL);
...
int Compiler_record_origin(Compiler c, Token token){
  if(! _init_guard_) _file_init_();
  if(! token) return 0;
  String file = String_truth(c -> filename) ? c -> filename : _710;
...
static void _report_script_statement(Compiler c){
  Compiler_report_error(c, 33658058, _711, c -> token, _64);
}
...
static String _declaration_path(String path, int thaw){
  if(! String_truth(path) || String_startswith(path, _712)) return path;  return thaw ? home_absolute_path(path) : home_portable_path(path);
}
...
int remaining = Map_len(pending);  while(remaining){
  ...
  if(remaining && remaining == previous) Compiler_report_error(shadow, 1362954, _713, shadow -> token, NULL);
}
{
  ...
  if(c -> source_private < 0) return; {
    List directive;  List _x2c_macro_object_24 = directives;  List _x2c_macro_cursor_24 = _x2c_macro_object_24;  Var _x2c_macro_cursor_output_23;  while(List_try_next(_x2c_macro_object_24, & _x2c_macro_cursor_24, & _x2c_macro_cursor_output_23)){
      directive = Var_list(_x2c_macro_cursor_output_23); {
        String content = Var_string(List_cadr(directive));  if(String_contains(content, _714)) c -> source_private = 1;  else if(String_contains(content, _715)) c -> source_private = 0;
      }
...
static int _is_reserved_spelling(String s){
  if(! String_truth(s)) return 0;  if(String_startswith(s, _716)) return 1;  if(String_equal(s, _542)) return 1;  if(String_equal(s, _543)) return 1;  if(String_len(s) < 2 || String_getindex(s, 0) != '_') return 0;  for(int i = 1;  i < String_len(s);  i ++) if(String_getindex(s, i) < '0' || String_getindex(s, i) > '9') return 0;  return 1;
}
...
void Compiler_register_package_alias(Compiler compiler, String name, String alias, Token token){
  ...
  _check_package_binding(compiler, _717, alias, token);
...
void Compiler_register_package_member(Compiler c, String name, String member, String local, Token member_token, Token local_token){
  ...
  _check_package_binding(c, _718, local, local_token);
...
List Sym_declare(Sym sym, List context, List key, List ast){
  ...
  if(! List_truth(binding)) binding = Sym_define(sym, Type_list(ctxkey), (List) type);
    ...
    if((int) Block_len(sym -> scopes) > sym -> base_scopes) Map_setindex(sym -> binding_facts, List_var(cons(_9, cons(List_var(binding), NULL))), String_var(Compiler_fresh_name(sym -> compiler, _719)));
  }
  if(! List_truth(context) &&(int) Block_len(sym -> scopes) > sym -> base_scopes){
    ...
    if(String_truth(_declared_var_converter_owner(key, global_type)) && ! Map_contains(sym -> binding_facts, List_var(cons(_9, cons(List_var(binding), NULL))))) Map_setindex(sym -> binding_facts, List_var(cons(_9, cons(List_var(binding), NULL))), String_var(Compiler_fresh_name(sym -> compiler, _720)));
  }
  return binding;
}
...
List Sym_bind_identity(Sym s, List context, List binding, List ast){
  ...
  if(context == _554){
    ...
    if((int) Block_len(s -> scopes) > s -> base_scopes) Map_setindex(s -> binding_facts, List_var(cons(_9, cons(List_var(binding), NULL))), String_var(Compiler_fresh_name(s -> compiler, _719)));
  }
...
if(List_equal(Var_list(prior_contract), contract)){
  ...
  if(Var_equal(state_kind, Symbol_var(292902696930268)) || Var_equal(state_kind, Symbol_var(7656878481736))) _report_redefinition(c, _721, binding);
}
...
case 44661285196: ;  static MatchCaptureSite _x2c_match_site_58;  if (x2c_match_site_try_capture(& _x2c_match_site_58, _x2c_match_expr, List_var(_639), &_x2c_match_capture)) {key = node;  break;
}
default: break;
    }
  }
if(List_truth(key)) Map_setindex(Compiler_semantic_binding_facts(c), List_var(cons(_640, cons(List_var(key), NULL))), List_var(cons(int_var(start), cons(int_var(end), cons(int_var(c -> source_private > 0), NULL)))));
}
...
static void _record_top_level_function_state(Compiler compiler, List node){

  {
    ...
    Var _x2c_match_values[3];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 3 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 8932560010: ;  static MatchCaptureSite _x2c_match_site_59;  if (x2c_match_site_try_capture(& _x2c_match_site_59, _x2c_match_expr, List_var(_646), &_x2c_match_capture)) {Var declared = _x2c_match_values[0];  List bindings = Var_list(_x2c_match_values[1]); {
...
case 458361162716: ;  static MatchCaptureSite _x2c_match_site_60;  if (x2c_match_site_try_capture(& _x2c_match_site_60, _x2c_match_expr, List_var(_656), &_x2c_match_capture)) {Var return_type = _x2c_match_values[0];  Var target = _x2c_match_values[1];  Var binding = _x2c_match_values[2]; {
...
static void _typedef_budget_error(Sym sym, Type origin){
  String message = String_join(NULL, cons(String_var(_657), cons(String_var(List_repr(Type_list(origin))), NULL)));  Compiler_report_error(sym -> compiler, 1362954, message, NULL, NULL);
}
...
static Type _resolve_key_helper(Sym sym, Type key, Type stop, Type origin, int hops){
...

  {
    ...
    Var _x2c_match_values[2];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 2 };
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_61;  if (x2c_match_site_try_capture(& _x2c_match_site_61, _x2c_match_expr, List_var(_667), &_x2c_match_capture)) {Var kind = _x2c_match_values[0];  Var spelling = _x2c_match_values[1];  if(! List_truth(Sym_field_order(sym, key))) return List_type(cons(kind, cons(spelling, NULL)));  break;
}
...
static Type _builtin_typedef_scalar(Type key){
  if(! Type_is_bare_typedef_name(key)) return NULL;  String name = Var_string(List_car(Type_list(key)));  switch(String_symbol(name)){
    case 30065 : case 1036417972854761 : return List_type(_671);  case 26993 : case 7275089256425 : return List_type(_673);  case 3846509 : case 1036417972614847 : return List_type(_676);  case 3453293 : case 931211394113513 : return List_type(_675);  case 3847013 : case 1036417972679359 : return List_type(_677);  case 3453797 : case 931211402371049 : case 49610332136 : return List_type(_679);  case 3847785 : case 1036417972778175 : case 46829405509608 : case 1295658984 : return List_type(_682);  case 3454569 : case 931211415019497 : case 649917143016 : case 36597704046568 : case 42097848296 : case 31864808 : case 1361915880 : return List_type(_681);  case 492352113 : return List_type(_684);  case 442020465 : return List_type(_683);  case 3355493 : return List_type(_686);  case 3356265 : return List_type(_688);  case 429437553 : return List_type(_689);
  }
  return NULL;
}
...
int Sym_is_map_type(Sym s, Type type){
  if(! _init_guard_) _file_init_();  return Sym_is_named_value_type(s, type, _728);
}
...
void Sym_declare_field_order(Sym sym, Type type, List fields){
  ...
  Sym_set(sym, List_append(Type_list(type), _692), cons(_693, List_append(Array_list_free(rows), NULL)));
}

List Sym_field_order(Sym sym, Type type){
  if(! _init_guard_) _file_init_();  return Sym_get(sym, List_append(Type_list(type), _692));
}
...
List Compiler_gensym(Compiler c){
  if(! _init_guard_) _file_init_();  String owner = String_truth(c -> filename) ? home_portable_path(Compiler_canonical_path(c, c -> filename)) : _729;  String key = String_join(NULL, cons(String_var(_696), cons(String_var(owner), NULL)));  Var stored;  int count = Map_try_get(c -> names -> counters, String_var(key), & stored) ? Var_int(stored) + 1 : 1;  Map_setindex(c -> names -> counters, String_var(key), int_var(count));  return cons(List_var(cons(_494, cons(String_var(owner), cons(int_var(count), NULL)))), NULL);
}
