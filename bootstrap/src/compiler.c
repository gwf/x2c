...
__attribute__((constructor)) static void _file_init_(void){
  ...
  _113 = String_new("packed");
  _114 = String_new("aligned");
  _115 = String_new("mode");
  _116 = String_new("vector_size");
  _117 = String_new("__attribute__");
  _118 = int_var(0);
  _119 = String_new("expected \'");
  _120 = String_new("\'");
  _121 = String_new("encountered \'}\' without matching \'{\'");
  _122 = String_var(_121);
  _123 = cons(_122, NULL);
  _124 = String_new("\'{\' opened here");
  ...
  _164 = cons(_163, NULL);
  _165 = cons(_162, _164);
  _166 = Symbol_var(1044986460);
  _167 = Symbol_var(64628725140444);
  _168 = cons(_167, NULL);
  _169 = cons(_166, _168);
  _170 = Symbol_var(895740748108);
  _171 = Atom_intern(String_new("declaration-void"));
  _172 = cons(_171, NULL);
  _173 = Atom_intern(String_new("declaration-empty-symbol"));
  _174 = cons(_173, NULL);
  _175 = Atom_intern(String_new("declaration-atom"));
  _176 = Atom_intern(String_new("declaration-token"));
  _177 = Symbol_var(57834982);
  _178 = cons(_177, NULL);
  _179 = cons(_170, _178);
  _180 = Symbol_var(40070);
  _181 = Symbol_var(1950693980);
  _182 = Symbol_var(1911688);
  _183 = cons(_182, NULL);
  _184 = cons(_181, _183);
  _185 = cons(_163, _184);
  _186 = cons(_127, _185);
  _187 = List_var(_186);
  _188 = Symbol_var(61765898);
  _189 = cons(_188, NULL);
  _190 = cons(_187, _189);
  _191 = cons(_180, _190);
  _192 = Symbol_var(63322012252);
  _196 = Symbol_var(3453797);
  _197 = cons(_196, NULL);
  ...
  _204 = cons(_203, _189);
  _205 = cons(_86, _204);
  _206 = Atom_intern(String_new("declaration-origin"));
  _207 = Atom_intern(String_new("declaration-list"));
  _208 = cons(_207, NULL);
  _209 = cons(_206, _208);
  _210 = cons(_176, _209);
  _211 = cons(_175, _210);
  ...
  _216 = cons(_215, _73);
  _217 = cons(_207, _178);
  _218 = Symbol_var(65112065723278);
  _219 = cons(_218, NULL);
  _220 = cons(_175, _219);
  _221 = Symbol_var(62139944);
  _222 = Symbol_var(61623178);
  _223 = Symbol_var(62510639964);
  _224 = Symbol_var(63093751056);
  _225 = Symbol_var(64904693566428);
  _226 = cons(_225, NULL);
  _227 = cons(_224, _226);
  _228 = cons(_223, _227);
  _229 = cons(_222, _228);
  ...
  _233 = cons(_167, _189);
  _234 = cons(_206, _233);
  _235 = String_new("source-node");
  _236 = String_var(_235);
  _237 = Atom_intern(String_new("declaration"));
  _238 = cons(_163, _152);
  _239 = cons(_237, _238);
  _240 = List_var(_239);
  _241 = cons(_240, NULL);
  _242 = cons(_236, _241);
  _243 = Atom_intern(String_new("declaration-source"));
  _244 = Atom_intern(String_new("declaration-bundle"));
  _245 = Symbol_var(1211878);
  _246 = cons(_245, NULL);
  _247 = List_var(_246);
  _248 = cons(_247, NULL);
  _249 = cons(_244, _248);
  _250 = List_var(_249);
  _251 = cons(_250, NULL);
  _252 = Symbol_var(39266);
  _253 = Symbol_var(61829938);
  _254 = cons(_253, NULL);
  _255 = cons(_252, _254);
  _256 = cons(_245, _73);
  _257 = List_var(_256);
  ...
  _267 = Symbol_var(2044146024281382);
  _268 = Atom_intern(String_new("?construction"));
  _269 = Symbol_var(2028452841714);
  _270 = cons(_269, NULL);
  _271 = cons(_268, _270);
  _272 = cons(_267, _271);
  _273 = cons(_266, _272);
  _274 = cons(_265, _273);
  _275 = Symbol_var(59597595644252);
  _276 = cons(_275, NULL);
  _277 = cons(_252, _276);
  _278 = cons(_245, _276);
  _279 = List_var(_278);
  _280 = cons(_279, NULL);
  _281 = cons(_244, _280);
  _282 = Atom_intern(String_new("declaration-default"));
  _283 = Symbol_var(64230035573724);
  _284 = cons(_283, _271);
  _285 = cons(_282, _284);
  _286 = Atom_intern(String_new("?return_type"));
  _287 = Symbol_var(61737802);
  ...
  _317 = Atom_intern(String_new("?parameters"));
  _318 = cons(_317, NULL);
  _319 = cons(_316, _318);
  _320 = List_var(_319);
  _321 = cons(_320, _73);
  _322 = String_new("\' requires an explicit variadic constructor");
  _323 = Symbol_var(1473096);
  _324 = cons(_323, NULL);
  _325 = String_new("argument");
  _326 = Symbol_var(33656922);
  _327 = List_var(NULL);
  _328 = cons(_327, NULL);
  _329 = Symbol_var(199448);
  _330 = Symbol_var(102886);
  _331 = Symbol_var(199912);
  _332 = Symbol_var(1077021542);
  _333 = Atom_intern(String_new("declaration-forward"));
  _334 = Symbol_var(1952992008);
  _335 = Symbol_var(63354055592);
  _336 = Symbol_var(63160783204);
  _337 = Symbol_var(64186969360598);
  _338 = cons(_337, _270);
  _339 = cons(_336, _338);
  _340 = cons(_335, _339);
  _341 = cons(_334, _340);
  ...
  _366 = cons(_365, _360);
  _367 = cons(_243, _366);
  _368 = Symbol_var(35579270086);
  _369 = String_new("__declspec");
  _370 = cons(_264, _73);
  _371 = cons(_72, _370);
  _372 = Symbol_var(64399105871154);
  _373 = cons(_372, _152);
  _374 = cons(_15, _373);
  _375 = List_var(_374);
  _376 = cons(_375, NULL);
  ...
  _485 = cons(_192, _484);
  _486 = cons(_86, _485);
  _487 = String_new("\' is declared among the script\'s statements");
  _488 = String_new("functions cannot see those locals;");
  _489 = String_var(_488);
  _490 = String_new("declare it static to share it");
  _491 = String_var(_490);
  _492 = cons(_491, NULL);
  _493 = cons(_489, _492);
  _494 = String_new("x2c_script_statements");
  _495 = String_new("tokenize");
  _496 = String_var(_495);
  _497 = cons(_496, NULL);
  _498 = cons(_316, _497);
  _499 = List_var(_498);
  _500 = Symbol_var(1322536);
  _501 = Symbol_var(805770);
  _502 = Symbol_var(7128);
  _503 = Symbol_var(6363658);
  _504 = cons(_503, _152);
  _505 = Symbol_var(59976);
  _506 = cons(_505, NULL);
  _507 = cons(_503, _506);
  _508 = List_var(_507);
  _509 = cons(_508, NULL);
  ...
  _533 = cons(_525, _530);
  _534 = cons(_4, _533);
  _535 = Symbol_var(29272);
  _536 = cons(_535, NULL);
  _537 = Symbol_var(228262);
  _538 = String_new("String");
...
static int _layout_attribute(Token open, int * packed){
  Token close = Token_group_close(open);  int depth = 0, layout = 0;  for(Token t = open;  t < close;  t ++){
    depth += Symbol_group_step(t -> type);  if(depth != 1 || t -> type != 19147688) continue;  String word = String_strip(t -> text, "_");  if(String_equal(word, _113)){
      layout = 1; (* packed) = 1;
    }
    else if(String_equal(word, _114) || String_equal(word, _115) || String_equal(word, _116)) layout = 1;
  }
  return layout;
}
...
static void _note_layout_macro(String content, Map layout, int conditional){
  int undefined;  Token name = _macro_directive(content, &(undefined));  if(! name) return;  if(! conditional) Map_del(layout, String_var(name -> text));  if(undefined) return;  Token token = name + 1;  if(token -> type == 81) token = Token_after_group(token);  int value = 0;  for(;  token -> type != 11212;  token = _skip_forward(token + 1)){
    if(token -> type != 19147688) continue;  if(String_equal(token -> text, _117)){
...
Symbol Compiler_expect(Compiler c, Symbol type){
  if(! _init_guard_) _file_init_();  if(c -> token -> type != type){
    Compiler_require_input(c);  Compiler_report_error(c, 33658058, String_join(NULL, cons(String_var(_119), cons(String_var(Symbol_str(type)), cons(String_var(_120), NULL)))), c -> token, NULL);
  }
...
List Compiler_anchor_origin(Compiler compiler, List node, Token token){
  if(! _init_guard_) _file_init_();  if(! List_truth(node)) return node;  if(Map_truth(compiler -> macro_holes)) return cons(_86, cons(_128, cons(List_var(node), NULL)));  int occurrence = Compiler_record_origin(compiler, token);  if(! occurrence) return node;  return cons(_86, cons(int_var(occurrence), cons(List_var(node), NULL)));
}
...
static List _declaration_location(Compiler compiler, List location, int thaw){
...

  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 412426: ; { List _x2c_match_cursor;  if (_x2c_match_expr && _x2c_match_expr->car.u64 == 9224497936762030858ULL && (_x2c_match_cursor = _x2c_match_expr->cdr, 1) && _x2c_match_cursor && (_x2c_match_values[0] = _x2c_match_cursor->car, _x2c_match_cursor = _x2c_match_cursor->cdr, 1) && !_x2c_match_cursor) {Var path = _x2c_match_values[0];  row = cons(_162, cons(String_var(_declaration_path(Var_string(path), thaw)), NULL));  break; } } default: break;
    }
  }
...
Array_push(result, List_var(row));
  ...
  return cons(_170, List_append(Array_list_free(result), NULL));
}
...
Var Compiler_freeze_declaration_syntax(Compiler c, Var syntax){
  if(! _init_guard_) _file_init_();  if(Var_is_void(syntax)) return List_var(_172);  if(Var_is(syntax, 1328354264) && ! Var_symbol(syntax)) return List_var(_174);  if(Var_is_atom(syntax) && ! Atom_bare_spelling(Var_str(syntax))) return List_var(cons(_175, cons(String_var(Var_str(syntax)), NULL)));  if(Var_is_row(syntax, 11, 7, 5)){
    Token token = Var_token(syntax);  return List_var(cons(_176, cons(String_var(Symbol_str(token -> type)), cons(String_var(token -> text), cons(int_var(token -> line), cons(int_var(token -> col), cons(int_var(token -> len), cons(int_var(token -> pos), NULL))))))));
  }
  if(! Var_is_row(syntax, 9, 7, 4) || Var_is_nil(syntax)) return syntax;
  {
    ...
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 895740748108: ;  static MatchCaptureSite _x2c_match_site_12;  if (x2c_match_site_try_capture(& _x2c_match_site_12, _x2c_match_expr, List_var(_179), &_x2c_match_capture)) {List rows = Var_list(_x2c_match_values[0]);  return List_var(_declaration_macro(c, rows, 0));  break;
}
case 40070: ;  static MatchCaptureSite _x2c_match_site_13;  if (x2c_match_site_try_capture(& _x2c_match_site_13, _x2c_match_expr, List_var(_191), &_x2c_match_capture)) {Var path = _x2c_match_values[0];  Var begin = _x2c_match_values[1];  Var end = _x2c_match_values[2];  Var node = _x2c_match_values[3];  return List_var(cons(_180, cons(List_var(cons(_127, cons(String_var(_declaration_path(Var_string(path), 0)), cons(begin, cons(end, NULL))))), cons(Compiler_freeze_declaration_syntax(c, node), NULL))));  break;
}
case 104: ; { List _x2c_match_cursor;  if (_x2c_match_expr && _x2c_match_expr->car.u64 == 9224497936761618536ULL && (_x2c_match_cursor = _x2c_match_expr->cdr, 1) && _x2c_match_cursor && Var_is(_x2c_match_cursor->car, 3453797) && (_x2c_match_values[0] = _x2c_match_cursor->car, _x2c_match_cursor = _x2c_match_cursor->cdr, 1) && _x2c_match_cursor && (_x2c_match_values[1] = _x2c_match_cursor->car, _x2c_match_cursor = _x2c_match_cursor->cdr, 1) && !_x2c_match_cursor) {Var origin = _x2c_match_values[0];  Var node = _x2c_match_values[1]; {
  Var _x2c_match_value_0 = origin; {
    int origin = Var_int(Var_convert(_x2c_match_value_0, 3453797)); {
      List location = Compiler_origin_location(c, origin);  if(! List_truth(location)) return List_var(cons(_86, cons(_128, cons(Compiler_freeze_declaration_syntax(c, node), NULL))));  return List_var(cons(_206, cons(List_var(_declaration_location(c, location, 0)), cons(Compiler_freeze_declaration_syntax(c, node), NULL))));
    }
...
Array rows = Array_new(); {
...

  {
    ...
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_14;  if (x2c_match_site_try_capture(& _x2c_match_site_14, _x2c_match_expr, List_var(_216), &_x2c_match_capture)) {return List_var(cons(_207, List_append(Array_list_free(rows), NULL)));  break;
}
...
Var Compiler_thaw_declaration_syntax(Compiler c, Var syntax){
  if(! _init_guard_) _file_init_();  if(! Var_is_row(syntax, 9, 7, 4) || Var_is_nil(syntax)) return syntax;
  {
    ...
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_15;  if (x2c_match_site_try_capture(& _x2c_match_site_15, _x2c_match_expr, List_var(_217), &_x2c_match_capture)) {List rows = Var_list(_x2c_match_values[0]); {
...
static MatchCaptureSite _x2c_match_site_16;  if (x2c_match_site_try_capture(& _x2c_match_site_16, _x2c_match_expr, List_var(_179), &_x2c_match_capture)) {List rows = Var_list(_x2c_match_values[0]);  return List_var(_declaration_macro(c, rows, 1));  break;
}
...
static MatchCaptureSite _x2c_match_site_18;  if (x2c_match_site_try_capture(& _x2c_match_site_18, _x2c_match_expr, List_var(_172), &_x2c_match_capture)) {return((void) 0, Void);  break;
}
static MatchCaptureSite _x2c_match_site_19;  if (x2c_match_site_try_capture(& _x2c_match_site_19, _x2c_match_expr, List_var(_174), &_x2c_match_capture)) {return Symbol_var((Symbol) 0);  break;
}
static MatchCaptureSite _x2c_match_site_20;  if (x2c_match_site_try_capture(& _x2c_match_site_20, _x2c_match_expr, List_var(_220), &_x2c_match_capture)) {Var spelling = _x2c_match_values[0];  return Atom_intern(Var_string(spelling));  break;
}
static MatchCaptureSite _x2c_match_site_21;  if (x2c_match_site_try_capture(& _x2c_match_site_21, _x2c_match_expr, List_var(_232), &_x2c_match_capture)) {Var type = _x2c_match_values[0];  Var text = _x2c_match_values[1];  Var line = _x2c_match_values[2];  Var column = _x2c_match_values[3];  Var length = _x2c_match_values[4];  Var position = _x2c_match_values[5]; {
...
static MatchCaptureSite _x2c_match_site_22;  if (x2c_match_site_try_capture(& _x2c_match_site_22, _x2c_match_expr, List_var(_234), &_x2c_match_capture)) {Var location = _x2c_match_values[0];  Var node = _x2c_match_values[1]; {
  List source = Var_list(location);  Array_push(c -> origins, List_var(cons(_127, cons(List_assoc(source, Symbol_var(412426)), cons(List_assoc(source, Symbol_var(805770)), cons(List_assoc(source, Symbol_var(233614172)), cons(List_assoc(source, Symbol_var(816725264)), cons(List_assoc(source, Symbol_var(1133019155420)), NULL))))))));  return List_var(cons(_86, cons(Var_box_ulong(Array_len(c -> origins)), cons(Compiler_thaw_declaration_syntax(c, node), NULL))));
}
break;
}
...
static List _declaration_source_key(Compiler compiler, Token token){
  String path = home_portable_path(Path_absolute(compiler -> filename));  return cons(_236, cons(List_var(cons(_237, cons(String_var(path), cons(int_var(token -> pos), NULL)))), NULL));
}
...
void Compiler_run_declaration_effects(Compiler c){
        ...
        List _x2c_destructure_1 = effect;  List key = Var_list(List_getindex(_x2c_destructure_1, 0));  int end = Var_int(Var_convert(List_getindex(_x2c_destructure_1, 1), 3453797));  String form = Var_string(List_getindex(_x2c_destructure_1, 2));  Var site = List_getindex(_x2c_destructure_1, 3);  String context = Var_string(List_getindex(_x2c_destructure_1, 4));  String filename = c -> filename;
  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_23;  if (x2c_match_site_try_capture(& _x2c_match_site_23, _x2c_match_expr, List_var(_242), &_x2c_match_capture)) {Var path = _x2c_match_values[0];  c -> filename = _declaration_path(Var_string(path), 1);  break;
      }
...
static List _declaration_forward(Compiler compiler, Type child, Type parent, String member, List fallback, Map pending){
  String name = String_join(NULL, cons(String_var(Var_str(List_car(Type_list(child)))), cons(String_var(_99), cons(String_var(member), NULL))));  if(List_truth(Sym_get(compiler -> sym, cons(String_var(name), NULL)))) return _310;  List method = Compiler_resolve_postfix_member(compiler, parent, cons(String_var(member), NULL), 93, 1);  if(! List_truth(method)){
...
if(! List_truth(Type_list(signature))) return NULL;  List types = NULL;
  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_32;  if (x2c_match_site_try_capture(& _x2c_match_site_32, _x2c_match_expr, List_var(_321), &_x2c_match_capture)) {Var parameters = _x2c_match_values[0];  types = Var_list(parameters);  break;
}
...
static List _replay_declaration_bundle(Compiler compiler){
  List source = Sym_get(compiler -> sym, _declaration_source_key(compiler, compiler -> token));
  {
    ...
    Var _x2c_match_values[2];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 2 };
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_37;  if (x2c_match_site_try_capture(& _x2c_match_site_37, _x2c_match_expr, List_var(_367), &_x2c_match_capture)) {Var end = _x2c_match_values[0];  Var syntax = _x2c_match_values[1]; {
...
List Compiler_leading_preproc(Compiler compiler){
  if(! _init_guard_) _file_init_();  List noncode = NULL;  Token base = compiler -> tokenizer -> tokens, token = compiler -> token;  if(token == base) return NULL;  while(-- token >= base){
    switch(token -> type){
      case 40896714 : case 7477210024 : break;  case 35579270086 : noncode = cons(List_var(cons(_368, cons(String_var(token -> text), NULL))), noncode);  break;  default: return noncode;
    }
...
static int _prefix_rank(Var v){
  if(! Var_is_row(v, 9, 7, 4)) return 0;  if(List_truth(({ static MatchCaptureSite _x2c_match_site_38;  x2c_match_site_match(& _x2c_match_site_38, Var_list(v), List_var(_371)); }))) return 4; {
...
static void _collect_binding_references(Var node, Map referenced){
  if(! Var_is_row(node, 9, 7, 4)) return;  List syntax = Var_list(node);
  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 19147688: ;  static MatchCaptureSite _x2c_match_site_39;  if (x2c_match_site_try_capture(& _x2c_match_site_39, _x2c_match_expr, List_var(_377), &_x2c_match_capture)) {Var identity = _x2c_match_values[0]; {
...
static Var _meta_identity(List definition){

  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 458361162716: ;  static MatchCaptureSite _x2c_match_site_40;  if (x2c_match_site_try_capture(& _x2c_match_site_40, _x2c_match_expr, List_var(_383), &_x2c_match_capture)) {Var identity = _x2c_match_values[0];  return identity;  break;
}
case 8932560010: ;  static MatchCaptureSite _x2c_match_site_41;  if (x2c_match_site_try_capture(& _x2c_match_site_41, _x2c_match_expr, List_var(_393), &_x2c_match_capture)) {Var identity = _x2c_match_values[0];  return identity;  break;
}
static MatchCaptureSite _x2c_match_site_42;  if (x2c_match_site_try_capture(& _x2c_match_site_42, _x2c_match_expr, List_var(_399), &_x2c_match_capture)) {Var identity = _x2c_match_values[0];  return identity;  break;
}
default: break;
    }
  }
...
static void _check_script_locals(Compiler c, List ast){
      ...
      node = Var_list(_x2c_macro_cursor_output_30);
  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 458361162716: ;  static MatchCaptureSite _x2c_match_site_45;  if (x2c_match_site_try_capture(& _x2c_match_site_45, _x2c_match_expr, List_var(_413), &_x2c_match_capture)) {List items = Var_list(_x2c_match_values[0]); {
          ...
          item = Var_list(_x2c_macro_cursor_output_29);
  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 104: ;  static MatchCaptureSite _x2c_match_site_44;  if (x2c_match_site_try_capture(& _x2c_match_site_44, _x2c_match_expr, List_var(_424), &_x2c_match_capture)) {List bindings = Var_list(_x2c_match_values[0]); {
              ...
              binding = Var_list(_x2c_macro_cursor_output_28);
  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (0) {
      default: ;  static MatchCaptureSite _x2c_match_site_43;  if (x2c_match_site_try_capture(& _x2c_match_site_43, _x2c_match_expr, List_var(_456), &_x2c_match_capture)) {Var name = _x2c_match_values[0]; {
...
if(! Map_len(locals)) return; {
    ...
    node = Var_list(_x2c_macro_cursor_output_32);
  {
    ...
    Var _x2c_match_values[2];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 2 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 458361162716: ;  static MatchCaptureSite _x2c_match_site_46;  if (x2c_match_site_try_capture(& _x2c_match_site_46, _x2c_match_expr, List_var(_480), &_x2c_match_capture)) {Var function = _x2c_match_values[0];  List items = Var_list(_x2c_match_values[1]); {
      Var _x2c_match_value_5 = function; {
        String function = Var_string(_x2c_match_value_5); {
          if(String_equal(function, _481) || String_equal(function, _482)) continue; {
...
static void _append_script_main(Compiler c, Array statements){
  Token tokens = c -> tokenizer -> tokens, eof = c -> token;  long kept = _skip_backward(eof - 1, tokens) + 1 - tokens;  Token first = tokens + Var_integer(Array_getindex(statements, 0));  Bytes stream = Bytes_new(sizeof(struct Token));  stream = Bytes_append(stream, tokens, kept);  Tokenizer template = Tokenizer_new((char *) script_main, 3945159);  Tokenizer_scan(template);  for(Token token = template -> tokens;  token -> type != 11212;  token ++){
    if(String_equal(token -> text, _494)){
...
static void _debug_tokens(Compiler compiler, Token start, Token end){
  if(! log_should_log(8721742, 45035245130084)) return;  for(Token tok = start;  tok < end;  tok ++) if(tok -> type != 40896714 && tok -> type != 7477210024 && tok -> type != 35579270086) log_debug(45035245130084, cons(_499, cons(List_var(cons(_198, cons(Symbol_var(tok -> type), NULL))), cons(List_var(cons(_500, cons(String_var(tok -> text), NULL))), cons(List_var(cons(_501, cons(int_var(tok -> line), NULL))), cons(List_var(cons(_502, cons(int_var(tok -> col), NULL))), NULL))))));
}
...
static List _cache_alias(List key){

  {
    ...
    Var _x2c_match_values[1];  MatchCaptureBuffer _x2c_match_capture = { .values = _x2c_match_values, .capacity = 1 };
    switch (Var_symbol(car(_x2c_match_expr))) {
      case 6363658: ;  static MatchCaptureSite _x2c_match_site_47;  if (x2c_match_site_try_capture(& _x2c_match_site_47, _x2c_match_expr, List_var(_504), &_x2c_match_capture)) {return key;  break;
}
case 377892: ;  static MatchCaptureSite _x2c_match_site_48;  if (x2c_match_site_try_capture(& _x2c_match_site_48, _x2c_match_expr, List_var(_511), &_x2c_match_capture)) {Var id = _x2c_match_values[0];  return cons(_503, cons(id, NULL));  break;
}
case 45156: ;  static MatchCaptureSite _x2c_match_site_49;  if (x2c_match_site_try_capture(& _x2c_match_site_49, _x2c_match_expr, List_var(_521), &_x2c_match_capture)) {Var id = _x2c_match_values[0];  return cons(_503, cons(id, NULL));  break;
}
static MatchCaptureSite _x2c_match_site_50;  if (x2c_match_site_try_capture(& _x2c_match_site_50, _x2c_match_expr, List_var(_527), &_x2c_match_capture)) {Var id = _x2c_match_values[0];  return cons(_503, cons(id, NULL));  break;
}
default: break;
    }
  }
...
List Compiler_cache(Compiler c, List key){
  if(! _init_guard_) _file_init_();  List alias = _cache_alias(key);  if(List_truth(alias)) return alias;  int nextid = Array_len(c -> id_keys), id = Var_int(Var_convert(Map_setdefault(c -> key_ids, List_var(key), int_var(nextid)), 3453797));  if(id == nextid) Array_push(c -> id_keys, List_var(key));  return cons(_503, cons(int_var(id), NULL));
}

List Compiler_cache_cons_cell(Compiler compiler, List head, List tail){
  if(! _init_guard_) _file_init_();  if(compiler -> runtime_literals) return NULL;  List head_cache = NULL, tail_cache = NULL;  if(List_truth(({ static MatchCaptureSite _x2c_match_site_51;  x2c_match_site_match(& _x2c_match_site_51, head, List_var(_532)); }))) head_cache = Var_list(List_caddr(head));  else if(List_truth(({ static MatchCaptureSite _x2c_match_site_52;  x2c_match_site_match(& _x2c_match_site_52, head, List_var(_528)); }))) head_cache = head;  if(! List_truth(head_cache)) return NULL;  if(List_truth(({ static MatchCaptureSite _x2c_match_site_53;  x2c_match_site_match(& _x2c_match_site_53, tail, List_var(_534)); }))) tail_cache = Var_list(List_caddr(tail));  else if(List_truth(({ static MatchCaptureSite _x2c_match_site_54;  x2c_match_site_match(& _x2c_match_site_54, tail, List_var(_536)); }))) tail_cache = tail;  if(! List_truth(tail_cache)) return NULL;  List cached = Compiler_cache(compiler, cons(_537, cons(List_var(head_cache), cons(List_var(tail_cache), NULL))));  return cons(_4, cons(_525, cons(List_var(cached), NULL)));
}
...
List Compiler_cache_literal_var(Compiler compiler, Var value){
  if(! _init_guard_) _file_init_();  if(Var_is_row(value, 9, 7, 4)){
    List cached = _cache_literal_list(compiler, Var_list(value));  return Compiler_cache(compiler, cons(_512, cons(List_var(cons(_4, cons(_525, cons(List_var(cons(_4, cons(_525, cons(List_var(cached), NULL)))), NULL)))), NULL)));
  }
  if(Var_is_row(value, 11, 7, 1)){
    List literal = cons(_4, cons(_541, cons(List_var(cons(_28, cons(_541, cons(value, NULL)))), NULL)));  List cached = Compiler_cache(compiler, cons(_299, cons(List_var(literal), NULL)));  return Compiler_cache(compiler, cons(_512, cons(List_var(cons(_4, cons(_541, cons(List_var(cached), NULL)))), NULL)));
  }
...
List Compiler_cache_literal_list(Compiler compiler, List values){
  if(! _init_guard_) _file_init_();  List cached = _cache_literal_list(compiler, values);  return cons(_4, cons(_525, cons(List_var(cons(_4, cons(_525, cons(List_var(cached), NULL)))), NULL)));
}
