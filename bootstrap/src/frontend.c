...
static List _108, _107, _106, _105, _104, _103, _102, _101, _100, _99, _98, _97, _96, _95, _93, _92, _88, _87, _83, _82, _78, _77, _73, _72, _68, _67, _63, _62, _58, _57, _53, _52, _48, _47, _43, _42, _38, _37, _33, _32, _28, _27, _18, _17, _12;

static String _114, _113, _112, _111, _110, _109, _24, _23, _22, _20, _19, _15, _13, _10, _9, _7, _6, _5, _4, _3, _2, _1, _0;

static Var _94, _91, _90, _89, _86, _85, _84, _81, _80, _79, _76, _75, _74, _71, _70, _69, _66, _65, _64, _61, _60, _59, _56, _55, _54, _51, _50, _49, _46, _45, _44, _41, _40, _39, _36, _35, _34, _31, _30, _29, _26, _25, _21, _16, _14, _11, _8;
...
static List native_modules;

_x2c_initializer_choice_1A2A7247_0((native_modules = NULL))
...
__attribute__((constructor)) static void _file_init_(void){
  ...
  _init_guard_ = 1;
  _0 = String_new("cannot load native module \'");
  _1 = String_new("\': ");
  _2 = String_new("not an x2c native module: ");
  _3 = String_new("#include \"scripting.x\"");
  _4 = String_new("");
  _5 = String_new("/lib");
  _6 = String_new("/x2c.x");
  _7 = String_new("stage: driver");
  _8 = String_var(_7);
  _9 = String_new("file: ");
  _10 = String_new("reason: cannot open");
  _11 = String_var(_10);
  _12 = cons(_11, NULL);
  _13 = String_new("the host preprocessor reads the #! line as C, so --cpp-symbols,");
  _14 = String_var(_13);
  _15 = String_new("--live-symbols, and the --dump-cpp modes cannot read a script");
  _16 = String_var(_15);
  _17 = cons(_16, NULL);
  _18 = cons(_14, _17);
  _19 = String_new("/lib/x2c.x");
  _20 = String_new("stage: preprocess");
  _21 = String_var(_20);
  _22 = String_new("status: ");
  _23 = String_new("<repl>");
  _24 = String_new("/lib/meta.x");
  _25 = Atom_intern(String_new("x2c_expr_ident"));
  _26 = Atom_intern(String_new("x2c.expr.ident"));
  _27 = cons(_26, NULL);
  _28 = cons(_25, _27);
  _29 = List_var(_28);
  _30 = Atom_intern(String_new("x2c_expr_index"));
  _31 = Atom_intern(String_new("x2c.expr.index"));
  _32 = cons(_31, NULL);
  _33 = cons(_30, _32);
  _34 = List_var(_33);
  _35 = Atom_intern(String_new("x2c_expr_field"));
  _36 = Atom_intern(String_new("x2c.expr.field"));
  _37 = cons(_36, NULL);
  _38 = cons(_35, _37);
  _39 = List_var(_38);
  _40 = Atom_intern(String_new("x2c_expr_call"));
  _41 = Atom_intern(String_new("_x2c.expr.call-list"));
  _42 = cons(_41, NULL);
  _43 = cons(_40, _42);
  _44 = List_var(_43);
  _45 = Atom_intern(String_new("x2c_expr_composite"));
  _46 = Atom_intern(String_new("x2c.expr.composite"));
  _47 = cons(_46, NULL);
  _48 = cons(_45, _47);
  _49 = List_var(_48);
  _50 = Atom_intern(String_new("x2c_expr_cast"));
  _51 = Atom_intern(String_new("x2c.expr.cast"));
  _52 = cons(_51, NULL);
  _53 = cons(_50, _52);
  _54 = List_var(_53);
  _55 = Atom_intern(String_new("x2c_function_body"));
  _56 = Atom_intern(String_new("x2c.function.body"));
  _57 = cons(_56, NULL);
  _58 = cons(_55, _57);
  _59 = List_var(_58);
  _60 = Atom_intern(String_new("x2c_parameters_arguments"));
  _61 = Atom_intern(String_new("x2c.parameters.arguments"));
  _62 = cons(_61, NULL);
  _63 = cons(_60, _62);
  _64 = List_var(_63);
  _65 = Atom_intern(String_new("x2c_stmnt_make"));
  _66 = Atom_intern(String_new("x2c.stmnt.make"));
  _67 = cons(_66, NULL);
  _68 = cons(_65, _67);
  _69 = List_var(_68);
  _70 = Atom_intern(String_new("x2c_stmnt_return"));
  _71 = Atom_intern(String_new("x2c.stmnt.return"));
  _72 = cons(_71, NULL);
  _73 = cons(_70, _72);
  _74 = List_var(_73);
  _75 = Atom_intern(String_new("x2c_block_make"));
  _76 = Atom_intern(String_new("x2c.block.make"));
  _77 = cons(_76, NULL);
  _78 = cons(_75, _77);
  _79 = List_var(_78);
  _80 = Atom_intern(String_new("x2c_decl_make"));
  _81 = Atom_intern(String_new("x2c.decl.make"));
  _82 = cons(_81, NULL);
  _83 = cons(_80, _82);
  _84 = List_var(_83);
  _85 = Atom_intern(String_new("x2c_param_make"));
  _86 = Atom_intern(String_new("x2c.param.make"));
  _87 = cons(_86, NULL);
  _88 = cons(_85, _87);
  _89 = List_var(_88);
  _90 = Atom_intern(String_new("x2c_type_members"));
  _91 = Atom_intern(String_new("x2c.type.members"));
  _92 = cons(_91, NULL);
  _93 = cons(_90, _92);
  _94 = List_var(_93);
  _95 = cons(_94, NULL);
  ...
  _108 = cons(_29, _107);
  _109 = String_new("\n");
  _110 = String_new("cannot read input file");
  _111 = String_new("#!");
  _112 = String_new("script units use the default symbol collection");
  _113 = String_new("failed to run C preprocessor");
  _114 = String_new("$(begin)\n" "void print(String text);\n" "void println(String text);\n");
...
void Compiler_add_native_targets(Map(*)(void));
...
static void _load_native_module(String path){
  ...
  if(List_contains(native_modules, String_var(absolute))) return;
  void * handle = dlopen(absolute, RTLD_NOW | RTLD_LOCAL);
  if(! handle) x2c_driver_error(String_join(NULL, cons(String_var(_0), cons(String_var(path), cons(String_var(_1), cons(String_var(String_new(dlerror())), NULL))))));
  const char * stamp = dlsym(handle, "x2c_module_stamp");
  Map(* entry)(void) =(Map(*)(void)) dlsym(handle, "x2c_module_targets");
  if(! stamp || ! entry) x2c_driver_error(String_join(NULL, cons(String_var(_2), cons(String_var(path), NULL))));
  String expected = build_compiler_stamp();
  if(! String_truth(expected) || strcmp(stamp, expected)){
    fprintf(stderr, "x2c: error: native module was built by another compiler: %s\n" "note: rebuild it with this compiler\n", String_str(path));
    exit(2);
  }
  Compiler_add_native_targets(entry);
  native_modules = cons(String_var(absolute), native_modules);
  List_try_own(native_modules);
}
...
void Frontend_load_support(CliRequest request){
  ...
  {
    String path;
    List _x2c_macro_object_0 = request -> native_modules;
    List _x2c_macro_cursor_0 = _x2c_macro_object_0;
    Var _x2c_macro_cursor_output_0;
    while(List_try_next(_x2c_macro_object_0, & _x2c_macro_cursor_0, & _x2c_macro_cursor_output_0)){
      path = Var_string(_x2c_macro_cursor_output_0);
      _load_native_module(path);
    }
...
static String _script_text(String text){
  int end = String_find(text, _109);
  return String_join(NULL, cons(String_var(_3), cons(String_var(end < 0 ? _4 : String_getslice(text, end, -2147483648, 1)), NULL)));
}
...
static void _tokenize_input(Frontend frontend, ParsedUnit * unit, String filename){
  ...
  String text = NULL;
  if(! Compiler_read_source(c, filename, & text)) Compiler_report_error(c, 306819428, _110, NULL, cons(_8, cons(String_var(String_join(NULL, cons(String_var(_9), cons(String_var(filename), NULL)))), _12)));
  if(String_truth(text) && String_startswith(text, _111)){
    int end = String_find(text, _109);
...
static Map _preprocess_input(Frontend frontend, ParsedUnit * unit){
  ...
  if(c -> script) Compiler_report_error(c, 306819428, _112, _first_preprocessor_token(c), _18);
  ...
  String runtime = c -> prelude ? String_join(NULL, cons(String_var(root), cons(String_var(_19), NULL))) : NULL;
  ...
  if(status){
    List notes = cons(_21, cons(String_var(String_join(NULL, cons(String_var(_22), cons(String_var(int_str(status)), NULL)))), NULL));
    Compiler_report_error(c, 306819428, _113, _first_preprocessor_token(c), notes);
  }
  {
    String dependency;
  ...
  * unit =(ParsedUnit){
  ...
  ErrorHandler volatile _x2c_error_handler_0 = x2c_error_catch_site_push(&_x2c_exception_frame_0, &_x2c_catch_site_0, _x2c_catch_patterns_0);  x2c_exception_push(& _x2c_exception_frame_0);  if (!sigsetjmp(_x2c_exception_frame_0.env, 0)){
    if(String_truth(filename)){
      ...
      compiler -> filename = _23;  compiler -> prelude = compiler -> runtime_inc = 1;  compiler -> include_dirs = frontend -> include_dirs;  Compiler_tokenize(compiler, String_truth(session_source) ? session_source : "$(begin)");
    }
...
static int _preload_meta_surface(Frontend frontend, Lisp shared){
  ...
  frontend = & session;
  ParsedUnit unit;
  String path = String_join(NULL, cons(String_var(x2c_get_root()), cons(String_var(_24), NULL)));
  ...
  x2c_cleanup_push(&_x2c_defer_record_0);
  {
    ...
    {
      Var name, alias;
      Iter _x2c_macro_iterator_2 = List_iter(builders, &(struct Iter){
        int_var(0)
      }
      );
      Var _x2c_macro_item_2;
      while(Iter_try_next(_x2c_macro_iterator_2, & _x2c_macro_item_2)){
        List _x2c_macro_pair_2;
        _x2c_macro_pair_2 = Var_list(_x2c_macro_item_2);
        name = List_getindex(_x2c_macro_pair_2, 0);
        alias = List_getindex(_x2c_macro_pair_2, 1);
        {
          Var initial;
    ...
    if(! started || ! ParsedUnit_collect(&(unit), frontend) || ! ParsedUnit_parse(&(unit))){
      {
        List diagnostic;
        List _x2c_macro_object_3 = Compiler_diagnostics(unit.compiler);
    ...
    {
      Var name, alias;
      Iter _x2c_macro_iterator_4 = List_iter(builders, &(struct Iter){
        int_var(0)
      }
      );
      Var _x2c_macro_item_4;
      while(Iter_try_next(_x2c_macro_iterator_4, & _x2c_macro_item_4)){
        List _x2c_macro_pair_4;
        _x2c_macro_pair_4 = Var_list(_x2c_macro_item_4);
        name = List_getindex(_x2c_macro_pair_4, 0);
        alias = List_getindex(_x2c_macro_pair_4, 1);
...
int Frontend_open_session(Frontend frontend, ParsedUnit * unit){
  if(! _init_guard_) _file_init_();
  return _start(frontend, NULL, unit, 0, _114) && ParsedUnit_collect(unit, frontend) && ParsedUnit_parse(unit);
}
