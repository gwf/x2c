    ...
    while(Map_try_next(_x2c_macro_object_5, & _x2c_macro_cursor_5, & _x2c_macro_cursor_output_5, & _x2c_macro_cursor_output_6)){
      ...
      value = _x2c_macro_cursor_output_6;
      {
        if(! Var_is(key, 1328354264)){
          static const X2CErrorSite _x2c_error_site_9 = {.file = "../../lib/process.x",.function = "Job_options",.line = 355};
        ...
        switch(name){
          ...
          break;
          default:{
            static const X2CErrorSite _x2c_error_site_10 = {.file = "../../lib/process.x",.function = "Job_options",.line = 383};
...
Job Job_check(Job job){
  ...
  if(captured && logged){
    static const X2CErrorSite _x2c_error_site_11 = {.file = "../../lib/process.x",.function = "Job_check",.line = 442};
  ...
  if(captured){
    static const X2CErrorSite _x2c_error_site_12 = {.file = "../../lib/process.x",.function = "Job_check",.line = 445};
  ...
  if(logged){
    static const X2CErrorSite _x2c_error_site_13 = {.file = "../../lib/process.x",.function = "Job_check",.line = 447};
  ...
  {
    static const X2CErrorSite _x2c_error_site_14 = {.file = "../../lib/process.x",.function = "Job_check",.line = 449};
...
Job Job_wait_any(Array jobs){
  {
    ...
    while(Array_try_next(_x2c_macro_object_6, & _x2c_macro_cursor_6, & _x2c_macro_cursor_output_7)){
      ...
      if(! job -> started){
        static const X2CErrorSite _x2c_error_site_15 = {.file = "../../lib/process.x",.function = "Job_wait_any",.line = 524};
