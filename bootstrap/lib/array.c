...
void Array_resize(Array arr, size_t size){
  if(size > INT_MAX){
    static const X2CErrorSite _x2c_error_site_1 = {.file = "../../lib/array.x",.function = "Array_resize",.line = 79};
...
static int _int_length(Array array){
  if(array -> length > INT_MAX){
    ...
    {
      static const X2CErrorSite _x2c_error_site_2 = {.file = "../../lib/array.x",.function = "_int_length",.line = 87};
...
static inline void _require_array_value(Var value){
  if(Var_is_void(value)){
    static const X2CErrorSite _x2c_error_site_3 = {.file = "../../lib/array.x",.function = "_require_array_value",.line = 94};
