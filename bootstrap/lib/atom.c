...
static int _escape_byte(String spelling, int index){
  ...
  if(index == 0 && ch == '<' && length > 1 && String_getindex(spelling, 1) != '=') return 1;
...
void Atom_initialize(void){
  ...
  if(! x2c_try_register_descriptor(_0, methods)){
    static const X2CErrorSite _x2c_error_site_0 = {.file = "../../lib/atom.x",.function = "Atom_initialize",.line = 182};
...
Atom Atom_intern(String spelling){
  ...
  if(! String_truth(spelling) || ! * spelling){
    static const X2CErrorSite _x2c_error_site_1 = {.file = "../../lib/atom.x",.function = "Atom_intern",.line = 223};
