#define _x2c_initializer_choice_E00406E8_0_expanded(_x2c_static_input_0) static void _x2c_static_initialize_0(void){\
  _x2c_static_input_0;\
}
#define _x2c_initializer_choice_E00406E8_0(_x2c_static_input_0) _x2c_initializer_choice_E00406E8_0_expanded(_x2c_static_input_0)
...
void x2c_error_catch_close(ErrorHandler handle){
  ...
  ErrorThreadState state = _thread();
  if(handle -> detached){
    if(state -> running_top != handle) _floor(20800632064936, "transferring catch close out of order");
...
#undef _x2c_initializer_choice_E00406E8_0
