...
static List _concat_n_va(unsigned list_count, va_list ap){
  if(list_count > INT_MAX){
    static const X2CErrorSite _x2c_error_site_1 = {.file = "../../lib/list.x",.function = "_concat_n_va",.line = 246};
  ...
  x2c_cleanup_push(&_x2c_defer_record_2);
  {
    for(unsigned i = 0;  i < element_count;  i ++){
      ...
      if(Var_is_void(value)){
        static const X2CErrorSite _x2c_error_site_2 = {.file = "../../lib/list.x",.function = "_n_va",.line = 272};
...
List List_getslice(List list, int start, int stop, int step){
  if(! step){
    static const X2CErrorSite _x2c_error_site_4 = {.file = "../../lib/list.x",.function = "List_getslice",.line = 763};
...
static int _unpack_n_va(List src, unsigned destination_count, va_list ap, int list_outputs){
  if(destination_count > INT_MAX){
    static const X2CErrorSite _x2c_error_site_5 = {.file = "../../lib/list.x",.function = "_unpack_n_va",.line = 778};
