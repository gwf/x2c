...
meta int String.contains_digit(String str);
...
meta int String.is_alpha(String s);
...
meta int String.is_alpha_under(String s);
...
meta int String.is_digit(String s);
...
meta int String.is_alnum(String s);
...
meta int String.is_alnum_under(String s);
...
meta int String.is_identifier(String s);
...
meta int String.is_space(String s);
...
meta int String.is_lower(String s);
...
meta int String.is_lower_under(String s);
...
meta int String.is_upper(String s);
...
meta int String.is_upper_under(String s);
