...
Source: `src/expressions.x:2577`

<a id="Compiler.postfix_completions"></a>
#### Compiler.postfix_completions

`List Compiler.postfix_completions( Compiler c, Type receiver, Symbol access)`
