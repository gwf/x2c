...
| Function | Summary |
| --- | --- |
| [`Frontend.load_support`](#Frontend.load_support) | Loads process-owned collection support and the requested native modules before units. |
