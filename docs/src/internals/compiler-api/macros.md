...
| Function | Summary |
| --- | --- |
| [`macro_library_defer`](#macro_library_defer) | Records that this process builds the shared compile-time parent between units rather than before the first one. |
