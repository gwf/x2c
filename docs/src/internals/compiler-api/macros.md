...
| [`Compiler.macro_targets_unit`](#Compiler.macro_targets_unit) | Reports whether the macro or keyword alias at the cursor produces file-scope syntax, directly or through the target it decorates. |
