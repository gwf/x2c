...
Source: `src/compiler.x:1099`

<a id="Compiler.at_completion"></a>
#### Compiler.at_completion

`int Compiler.at_completion(Compiler c)`
...
`List Compiler.optional_reference_test( Compiler c, List condition, int &truth)`
