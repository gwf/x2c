...
| [`Compiler.take_unit_state`](#Compiler.take_unit_state) | Takes over `owner`'s macro, import, keyword, and Lisp state for one segment of a collected file. |
