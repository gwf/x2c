...
| [`build_module_stamp`](#build_module_stamp) | Returns the stamp a native module records: `x2c-module-stamp:` and the content hash of the running compiler as 16 hex digits. |
