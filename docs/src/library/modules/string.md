...
| [`String.dedent`](#String.dedent) | Removes the indentation the text was written with. |
...
**See:** [`String.pool_release`](#String.pool_release),
[`String.pool_retain_named`](#String.pool_retain_named),
[`List.promote`](list.md#List.promote)

Source: `lib/string.x:149`
