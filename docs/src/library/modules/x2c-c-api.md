<!-- Generated by `python3 tools/gen-api-reference.py --write` from
     lib/*.x, src/utils.x, and the stage interfaces. Do not edit by hand. -->
...
| [`x2c_param_make`](meta.md#x2c_param_make) | `lib/meta.x` | `meta List x2c_param_make(List type, Var name)` |
