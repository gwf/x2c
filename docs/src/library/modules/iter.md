...
| [`Iter.new`](#Iter.new) | Returns zeroed iterator storage owned by the active `Scope`. |
...
Source: `lib/iter.x:865`

<a id="Iter.new"></a>
#### Iter.new

`meta native Iter Iter.new(void)`
