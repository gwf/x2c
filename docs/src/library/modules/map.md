...
`meta native void Map.cleanup(Map value)`
...
Source: `lib/map.x:284`

<a id="Map.copy"></a>
#### Map.copy

`meta native Self Map.copy(Self map)`
...
`meta native unsigned Map.len(Map map)`
...
`meta native Self Map.merge(Self map, Self other)`
