...
| [`lisp_static_address`](#lisp_static_address) | Reserves the stable, zeroed native address of a session-local static. |
| [`lisp_static_initialize`](#lisp_static_initialize) | Initializes a session-local static once. |
