...
into static helpers in the same translation unit safe. When conditional
compilation removes the initializer, that initialization still runs at the
same boundaries. Translation units that
